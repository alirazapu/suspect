...
class Person_model extends CI_Model
{
     ...
     * admin.js display keys: organization_name, ideological_stance_name, designation_name, is_trained, remarks
     * Form pre-fill keys: ideological_stance (raw int), designation (raw int)
     */
     ...
     * Form pre-fill key: training_camp (raw int)
     */
