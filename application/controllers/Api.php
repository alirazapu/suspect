    ...
    public function lookups()
    {
        try {
            $data = array(
                ...
                'training_camps'   => $this->Person_model->get_training_camps(),
                'org_stances'      => $this->Person_model->get_org_stances(),
                'org_designations' => $this->Person_model->get_org_designations(),
            );
            $this->_ok($data);
        } catch (Exception $e) {
